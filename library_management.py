                ...
                s=showerror(title="ERROR",message="Fill the entries")
                 ...
                 if(us=="rahul" and ps=="yadav02"):
                    ...
                    # Label(root,text="     FETCH DATA",font="Arial 14 italic",bg='light slategray').grid(row=7,column=5)
                     ...
                     def doner():
                         z=b.get()
                         cur.execute("delete from rahuliss where bno=(?)",(z,))
                         showinfo("task completed","return successfully")
                     ...
                     Button(root,text="DONE issue",bd=10,font='Arial 16 bold',command=done).grid(row=7,column=8)
                     Button(root,text="Clear",bd=10,font='Arial 16 bold',command=cleari).grid(row=6,column=8)
                     ...
                     Button(root,text="Done Return",bd=10,font='Arial 16 bold',command=doner).grid(row=7,column=5)
                     Button(root,text="Clear",bd=10,font='Arial 16 bold',command=clear).grid(row=6,column=5)
                     ...
                     Button(root,text="std.detail",bd=10,font='Arial 16 bold',command=sdt_info).grid(row=3,column=7)
                 else:
                     showerror(title="ERROR",message="check login instructions ")
...
toolbar = Label(shortcutbar, text='PYTHON PROJECT',bg='lightcyan',fg='black',height=2,font='comicsansms 12 bold')
toolbar.pack(side=TOP,fill=X,expand=YES)
shortcutbar.pack(expand=NO, fill=X)
shortcutbar2 = Frame(root3, height=90, bg='lime')
toolbar = Label(shortcutbar2, text="Welcome To Library",bg='black',fg='white',height=2,font='CalibriLight 12 bold')
toolbar.pack(side=TOP,fill=X,expand=YES)
...
shortcutbar2.pack(expand=NO, fill=X)
'''
shortcutbar3 = Frame(root3, height=60, bg='black')
toolbar2 = Label(shortcutbar3, text="PLEASE login first To Access",bg='black',fg='white',height=2,font='CalibriLight 12 bold')
toolbar2.pack(side=TOP,expand=NO)
shortcutbar3.pack(expand=NO, fill=X)

shortcutbar12 = Frame(root3, height=200, bg='lightcyan')
